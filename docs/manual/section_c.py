...
Six SOPs in ISO 9001:2015 format: Purpose, Scope, Responsibilities,
...
def section_c():
    ...
    out.append(lead(
        ...
        'Scheduler System. Each SOP follows the ISO 9001:2015 format '
        'and is identified by a unique code (SOP-XXX) referenced '
        'throughout this manual.'))

    out.append(callout(
        'Mandatory Reading',
        'All personnel who interact with the Dispatch Scheduler System '
        'are required to read and acknowledge the SOPs applicable to '
        'their role before operating the system unsupervised. '
        'Acknowledgement is recorded by the Management Representative '
        'in the Training Records (FM-001).',
        kind='iso'))
    ...
    out += sop_box(
        ...
        scope=(
            ...
            'trucks have either returned to BIG BEN SCM or been '
    ...
    out += sop_box(
        ...
        references=(
            'SOP-001 Daily Dispatch<br/>'
            'ISO 9001:2015 Clause 7.1.3 (Infrastructure)<br/>'
    ...
    out += sop_box(
        ...
        references=(
            'SOP-001 Daily Dispatch<br/>'
            'SOP-002 End-of-Day Reconciliation<br/>'
            'Manual v1.1 — Toll auto-fill decoupling change<br/>'
    ...
    out += sop_box(
        ...
        responsibilities=(
            ...
            'revocations.<br/>'
            '<b>Management Representative</b> — reviews access list '
            'quarterly.'),
        procedure=[
            ...
            '<b>Periodic review.</b> The Management Representative '
            'reviews the active user list every quarter and confirms '
            'each account is still required.',
        ...
        references=(
            'ISO 9001:2015 Clause 7.5.3 (Control of documented '
            'information)<br/>'
    ...
    out += sop_box(
        ...
        references=(
            'ISO 9001:2015 Clause 9.1 (Monitoring, measurement, '
