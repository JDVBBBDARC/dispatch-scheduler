"""Custom paragraph styles + page templates for the Big Ben Logistics
ISO 9001 System Manual. Imported by generate_manual.py.

Design goals:
- ISO-style formatting: clean Helvetica, sober colors, lots of whitespace
- Every page has a header (company + doc id) and footer (page X of Y)
- Section dividers use a maroon accent color matching the app's UI
- Callout boxes for procedures, warnings, and ISO clause references
"""
...
# ── Document constants ────────────────────────────────────────────────
COMPANY_NAME   = 'Big Ben Logistics'
DOC_TITLE      = 'Dispatch Scheduler System Manual'
DOC_ID         = 'BBL-QMS-MAN-001'
DOC_VERSION    = '1.1'
DOC_DATE       = 'May 2026'
PAGE_SIZE      = A4
...
def build_styles():
    ...
    # ISO clause reference — italic in margin
...
class ManualDocTemplate(BaseDocTemplate):
    ...
    def __init__(self, filename, **kwargs):
        super().__init__(filename, pagesize=PAGE_SIZE,
                         ...
                         subject='ISO 9001 Quality Management System Manual',
                         **kwargs)
